      ...
      >
        ...
        {!hasFile ? (
          <>
            ...
            >
              Busque por um arquivo PDF ou arraste até aqui
            </p>
            <p className="flex text-sm text-gray-500">
              <LockClosedIcon className="mr-1 mt-1 h-3 w-3 text-gray-400" />
              O progresso será salvo no seu navegador. Não o feche.
            </p>
          </>
        ) : (
        ...
        <div className="pt-4">
          {!hasFile ? (
            <>
              ...
              {hasNonPdfFile && (
                <p className="mt-6 text-red-400">Apenas PDF é suportado</p>
              )}
            </>
          ) : (
            <>
              ...
              <p className={cx("text-gray-500", !playgroundView && "mt-6")}>
                Nota: {!playgroundView ? "Importe" : "Parser"} funciona melhor com
                currículos de uma só coluna
              </p>
            </>
          )}
        </div>
